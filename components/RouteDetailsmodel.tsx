        ...
        <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {stopsCount > 1 && <p className="text-sm text-gray-500">{stops[0]} - {stops[stopsCount - 1]}</p>}
              </div>
            </div>
          ...
          <div className="overflow-y-auto flex-1 p-4 space-y-5">
            ...
            <div>
              ...
              <RouteMapPreview busName={result.name} stopsList={stops} />
              <button
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="relative w-full max-w-4xl h-[90vh] bg-white rounded-xl overflow-hidden">
            <button
              ...
              className="absolute top-3 right-3 z-50 p-2 rounded-full bg-white hover:bg-gray-100"
            >
              <X className="w-6 h-6" />
            </button>
            <RouteMap busName={result.name} stopsList={stops} />
          </div>
        </div>
      )}
    </>
